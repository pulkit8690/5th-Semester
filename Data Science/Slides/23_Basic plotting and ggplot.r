###############################################################
# Lab II - Basics of Ploting and ggplot
#-------------------------------------------------------------#
# #############################################################
...
# To get mode (Most occured element in a list)
getmode <- function(v) {
  uniqv <- unique(v)
...
# The idea behind the boxplot is that the 
# thick middle line represents the median and 
# the box is bounded by the first and third 
# quartiles. That is, the middle 50% of data 
# (the Interquartile Range or IQR) is held in 
# the box. The lines extend out to 1.5*IQR in 
# both directions. Outlier points are then
# plotted beyond that. It is important to note 
# that while 50% of the data are very visible 
# in the box, that means 50% of the data are 
# not really displayed. That is a lot of 
# information to not see.
